...
export default function SectionTransition({ text }: { text: string }) {
	...
	return (
		...
		>
			...
			<div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] h-[80vw] max-w-[1000px] max-h-[1000px] bg-brand/10 rounded-full blur-[150px] mix-blend-screen' />

			{/* Massive Parallax Text */}
			<motion.h2
				style={{ y, opacity }}
				className='font-display text-[20vw] font-extrabold tracking-tighter whitespace-nowrap text-foreground select-none'
			>
				{text}
			</motion.h2>
		</div>
